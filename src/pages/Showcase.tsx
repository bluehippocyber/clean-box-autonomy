...
.sc-app { position: relative; height: 100vh; width: 100vw; display: grid; grid-template-rows: 64px 1fr 32px; overflow: hidden; }
...
.sc-headline { font-size: clamp(36px, 4.4vw, 64px); font-weight: 500; letter-spacing: -0.035em; line-height: 0.98; margin-bottom: 18px; color: #fff; text-shadow: 0 4px 30px rgba(0,0,0,0.55); }
.sc-headline-italic { font-style: italic; font-weight: 300; color: var(--sc-silver); }
.sc-headline-red { color: var(--sc-red); }
.sc-sub { font-size: 15px; color: var(--sc-silver); max-width: 480px; line-height: 1.55; margin-bottom: 28px; }
...
.sc-seats-mini { display: flex; flex-direction: column; gap: 10px; border-left: 1px solid var(--sc-line); padding-left: 28px; }
.sc-seats-row { display: flex; justify-content: space-between; align-items: baseline; font-family: var(--sc-mono); font-size: 10.5px; letter-spacing: 0.22em; text-transform: uppercase; color: var(--sc-silver-2); }
.sc-seats-big { font-family: var(--sc-mono); font-size: 22px; font-weight: 500; color: #fff; letter-spacing: -0.01em; font-variant-numeric: tabular-nums; line-height: 1; }
.sc-seats-of { color: var(--sc-silver-2); font-size: 0.6em; margin-left: 4px; }
.sc-seats-bar { height: 3px; background: rgba(255,255,255,0.06); position: relative; }
.sc-seats-bar::before { content: ''; position: absolute; left: 0; top: 0; bottom: 0; width: 50%; background: var(--sc-red); box-shadow: 0 0 10px rgba(225,29,44,0.5); }
.sc-seats-red { color: var(--sc-red); }
.sc-countdown { margin-bottom: 28px; }
...
.sc-submit-btn { width: 100%; margin-top: 12px; padding: 16px; background: var(--sc-red); color: #fff; font-size: 12.5px; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; transition: all .2s ease; border: 1px solid var(--sc-red); display: flex; align-items: center; justify-content: center; gap: 12px; cursor: pointer; }
...
@media (max-width: 640px) {
  ...
  .sc-seats-mini { border-left: none; padding-left: 0; padding-top: 16px; border-top: 1px solid var(--sc-line); }
...
@media (max-height: 760px) and (min-width: 1100px) {
  ...
  .sc-headline { font-size: clamp(30px, 3.6vw, 44px); margin-bottom: 12px; }
  .sc-sub { margin-bottom: 18px; font-size: 14px; }
...
const TIERS = [
  { id: "general", label: "Tier 01", title: "General", price: "$297", display: "General Access" },
          ...
          <section className="sc-col sc-col-left">
            <div>
              ...
              <h1 className="sc-headline">
                ...
                <span className="sc-headline-italic">independent</span>{" "}
                <span className="sc-headline-red">bathing.</span>
              </h1>
              <p className="sc-sub">Clean Box Wave and Clean Box Tsunami — unveiled live. Twenty seats. One afternoon. By invitation and qualified application.</p>
              <div className="sc-price-strip">
                <div className="sc-price">
                  <span className="sc-price-amt">$297</span>
                  <div className="sc-price-meta">
                    <span className="sc-price-k">General Admission</span>
                    <span className="sc-price-v">VIP &amp; Founders from $1,000</span>
                  </div>
                </div>
                <div className="sc-seats-mini" aria-live="polite">
                  <div className="sc-seats-row">
                    <span>Seats Remaining</span>
                    <span className="sc-seats-big">10<span className="sc-seats-of">/ 20</span></span>
                  </div>
                  <div className="sc-seats-bar" />
                  <div className="sc-seats-row">
                    <span>50% Filled</span>
                    <span className="sc-seats-red">Closing Soon</span>
                  </div>
                </div>
              </div>
