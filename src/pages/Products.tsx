...
title: "Safe Entry",
description:
"The user approaches Clean Box and safely enters through the front-opening clamshell design. Integrated support positioning and seated access reduce slip-and-fall risk during bathing preparation.",
},
{
step: "02",
title: "Smart Cycle Selection",
description:
"The user or caregiver selects a preferred bathing cycle, water temperature, and pressure settings through the touchscreen interface. Future profile memory functionality can personalize repeat sessions.",
},
{
step: "03",
title: "Autonomous Cleansing",
description:
"Clean Box activates automated water delivery and integrated scrubbing systems designed to assist with full-body cleansing while the user remains seated comfortably throughout the process.",
},
{
step: "04",
title: "Automated Rinse & Drying",
description:
"Following the cleansing cycle, Clean Box performs a rinse sequence and activates the integrated drying system to reduce residual moisture and improve safe exiting conditions.",
},
{
step: "05",
title: "Comfortable Exit",
description:
"Once the cycle is complete, the front-access system opens and the user exits refreshed, dry, and with reduced caregiver dependency compared to traditional bathing workflows.",
},
];
...
Autonomous seated bathing technology designed for safety, dignity, operational efficiency, and independent care.
</p>
</div>
...
<div key={s.step} className="relative flex gap-8 items-start">
...
<span className="text-primary font-bold text-sm font-mono">{s.step}</span>
</div>
<div className="flex-1 pt-3">
<h3 className="text-xl font-bold mb-2">
Step {s.step} — {s.title}
</h3>
<p className="text-foreground/65 leading-relaxed">{s.description}</p>
</div>
</div>
))}
</div>
