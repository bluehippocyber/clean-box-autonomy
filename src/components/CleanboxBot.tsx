...
const GREETING: Msg = {
role: "bot",
text: "Welcome to Clean Box. I'm your Autonomous Care Assistant. Ask me anything about our Wave or Tsunami models, pricing, how it works, industries we serve, or how to reserve a showcase.",
};
...
return "Hey there! I'm the Clean Box AI assistant. Ask me about our Wave or Tsunami models, pricing, how it works, industries we serve, or how to book a private showcase demo.";
}
...
if (/(how it work|how does|process|step|entry|cycle|cleansing|rinse|exit|workflow|operation)/.test(q)) {
return "Clean Box operates in 5 seamless steps: (1) Safe Entry — the user enters through the front-opening clamshell design with integrated support. (2) Smart Cycle Selection — select bathing cycle, water temperature, and pressure via the touchscreen. (3) Autonomous Cleansing — automated water delivery and scrubbing systems handle full-body cleansing while the user stays seated. (4) Automated Rinse & Drying — a rinse sequence activates followed by the integrated drying system. (5) Comfortable Exit — the front-access system opens and the user exits refreshed, dry, and independent.";
}
...
if (/(showcase|demo|see it|watch|tour|experience|reserve|book|appointment|visit|ticket|pay|stripe)/.test(q)) {
return "The Clean Box Showcase is a LIMITED CAPACITY private demonstration event. You'll see the Tsunami in full operation, get a technical walkthrough from the founder, and leave with a custom ROI analysis. Reserve your spot now at https://buy.stripe.com/7sY00k5HdbUm4bO3aq4ZG00 — capacity is extremely limited. You can also click 'View Showcase' in the top navigation.";
}
...
if (/(safe|safety|emergency|stop|lock|door|fall|risk|injury|slip)/.test(q)) {
return "Safety is built into every layer of Clean Box. The seated clamshell design eliminates transfer risk and slip-and-fall danger. Integrated support positioning, non-locking safety entry, and automated pressure and temperature controls keep users comfortable and protected throughout every cycle. No standing required — ever.";
}
...
return "Clean Box was founded by Terrance King after watching his grandmother lose her independence inside a nursing home. He built the first prototype himself and has been developing the technology with a singular focus on dignity, safety, and operational efficiency ever since.";
}

if (/(social|instagram|facebook|twitter|x\.com|follow|media)/.test(q)) {
return "Follow Clean Box on social media: X (Twitter) at https://x.com/CleanBoxEnt — Instagram at https://www.instagram.com/cleanboxent — Facebook at https://www.facebook.com/CleanBoxEnt. Stay updated on product news, showcase dates, and company milestones.";
}
...
if (/(install|deploy|setup|how long|timeline|delivery|ship|rollout)/.test(q)) {
...
if (/(future|roadmap|coming|next|plan|ai|voice|profile|memory|analytics|remote|monitor)/.test(q)) {
return "Clean Box has an active innovation pipeline including: AI-Assisted Bathing Profiles, Personalized User Programs, Remote Diagnostic Monitoring, Usage Analytics Dashboard, Voice-Guided Bathing Experience, Caregiver Assistance Dashboard, Facility Fleet Management, Emergency Safety Detection, and Cloud-Based Device Updates — among others.";
}

return "Great question. For the most accurate answer about Clean Box technology, pricing, or deployment, reach out directly at Cleanboxinfo@cleanboxent.com or use the Contact form on our site. You can also reserve a private showcase at https://buy.stripe.com/7sY00k5HdbUm4bO3aq4ZG00 to see the full system in action.";
};
