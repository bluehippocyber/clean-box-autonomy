    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <nav className="container flex items-center justify-between h-20 py-4">
        ...
        <div className="hidden lg:block">
          <Link
            to="/showcase"
            className="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2 text-sm font-semibold text-white hover:bg-primary/90 transition-colors"
          >
            View Showcase
          </Link>
        </div>
      ...
      {open && (
        <div className="lg:hidden bg-background/95 backdrop-blur-xl border-b border-border px-4 pb-6">
          <div className="flex flex-col gap-4 pt-4">
            ...
            <Link
              to="/showcase"
              className="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white hover:bg-primary/90 transition-colors w-full mt-2"
